/*
Example sketch to test the Kamstrup meter readout 
/m26872 2022-10-16

Hardware: Arduino Mega and IR-eye and Kamstrup Omnipower 3ph electrical  meter with HAN-P1-module but IEC62056-7-5 and 2400 baud.
*/
...
#define SERIAL1_TX_PIN 18  //OBS! Tx1/Rx1 felmärkt på kines-arduino-mega
...
byte mac[]    = { 0xd6, 0x5d, 0xef, 0xaa, 0xc6, 0xd9 };
...
//const byte OBIS_timestamp[] = {0x01 0x00};		// Ex. 09 06 00 01 01   00 00 FF 09  0C       07 E6 (2022) 0A(10) 0F(15) 06(06) 16(22)    00 2D FF 80 00 00    .... at 2022-10-15 22:06 ?
...
//    exceptionProcess(DHCP_ERROR);
  }
  printIPAddress();
  Serial.println("Setting MQTT server...");
  delay(1500);
  client.setServer(server, 1883);
//  client.setCallback(callback);   // No callback yet
  delay(200);
/*
  while(Serial.available()){Serial.read();}
  Serial.println(F("Please press any key to start poll the Kamstrup for data!"));
  Serial.flush();
...
//				recvmsg[lastByteIdx] = r;
////				lastByteIdx = 0;
//				state = SEND; // Serial.println("state= SEND");
